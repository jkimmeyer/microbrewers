...
import add24Regular from '@iconify/icons-fluent/add-24-filled';
import subtract24Regular from '@iconify/icons-fluent/subtract-24-filled';
...
addIcon('subtract', subtract24Regular);
...
addIcon('person', person24Regular);
